...
function CrearCuenta() {
    ...
    return (
        <Layout>
        <div className="md:w-5/5 xl:w-3/5 mx-auto mb-32">
                ...
                <div className="w-full max-w-lg">
                    ...
                    >
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                type="password"
                                className="shadow appear ance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="password"
